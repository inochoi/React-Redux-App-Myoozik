...
const Homepage = () => {
    return (
        <div className='home'>
            ...
            <br/>
            <h1>Hello</h1>
            <button className='btn btn-outline-dark songLibrary'><Link to='/library'>Song Library</Link></button>
            <button className='btn btn-outline-dark playlists'><Link to='/playlist'>Playlists</Link></button>
        </div>
    );
}
